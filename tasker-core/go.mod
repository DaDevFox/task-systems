module github.com/DaDevFox/task-systems/tasker-core

go 1.25.11

replace github.com/DaDevFox/task-systems/tasker-core => ./
...
require (
	github.com/DaDevFox/task-systems/shared v0.0.0-00010101000000-000000000000
