...
func createTestRepository(t *testing.T) (*BadgerInventoryRepository, func()) {
	tempDir := t.TempDir()
...
func TestBadgerInventoryRepositoryAddItem(t *testing.T) {
...
func TestBadgerInventoryRepositoryGetItem(t *testing.T) {
	repo, cleanup := createTestRepository(t)
	defer cleanup()
...
func TestBadgerInventoryRepositoryUpdateItem(t *testing.T) {
	repo, cleanup := createTestRepository(t)
	defer cleanup()
...
func TestBadgerInventoryRepositoryGetAllItems(t *testing.T) {
	repo, cleanup := createTestRepository(t)
	defer cleanup()
...
func TestBadgerInventoryRepositoryGetLowStockItems(t *testing.T) {
	repo, cleanup := createTestRepository(t)
	defer cleanup()
